        ...
        <div className="flex items-center gap-3 shrink-0">
          {completed > 0 && (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 transition-colors shadow-sm shadow-emerald-600/10 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isExporting ? (
              ...
              {isExporting ? "Exporting..." : "Export All as Excel"}
            </button>
          )}
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-stone-900 text-white text-sm font-semibold hover:bg-stone-800 transition-colors shadow-sm shadow-stone-900/10 active:scale-[0.97]"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
